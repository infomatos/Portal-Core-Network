...
const PBI_URL = 'https://app.powerbi.com/reportEmbed?reportId=ab9e6b5a-396c-400c-bb4f-0f1eac1f6e51&autoAuth=true&ctid=57b8c96e-ac2f-4d78-a149-f1fc6817d3c4';

const META = {
  periodo: '—',
  atualizacao: '—',
  responsavel: 'CNE / Projetos',
};
  ...
  return (
    <div className="flex flex-col h-full min-h-0">
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-slate-400 mt-0.5 truncate">
                Painel consolidado dos projetos em andamento
              </p>
            </div>
          </div>
      ...
      <div ref={wrapperRef} className="flex-1 min-h-0 relative bg-slate-50">
        {!PBI_URL ? (
          <Placeholder file="projetos/VisaoGeral.tsx" />
        ) : (
          <>
...
function Placeholder({}: { file: string }) {
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 text-center px-6">
      ...
      <div>
        ...
        <p className="text-xs text-slate-400 mt-1">
          Entre em contato com o responsável pelo painel
        </p>
      </div>
    </div>
  );
