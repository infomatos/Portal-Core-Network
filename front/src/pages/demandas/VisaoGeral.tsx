...
const PBI_URL = 'https://app.powerbi.com/reportEmbed?reportId=4e8db179-3649-4c0c-baac-a7269a3f08f2&autoAuth=true&ctid=57b8c96e-ac2f-4d78-a149-f1fc6817d3c4';

const META = {
  periodo: '—',
  atualizacao: '—',
  responsavel: 'CNE / Demandas',
};
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-slate-400 mt-0.5 truncate">
                Painel consolidado das demandas em andamento
              </p>
            </div>
          </div>
  ...
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 text-center px-6">
      ...
      <div>
        ...
        <p className="text-xs text-slate-400 mt-1">Entre em contato com o responsável pelo painel</p>
      </div>
    </div>
  );
}
