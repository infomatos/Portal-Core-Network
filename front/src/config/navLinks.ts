...
{ to: '/orcamento',   label: 'Orçamento',   public: true, mega: true,
  ...
  { to: '/inventario',  label: 'Inventário',  public: true,
    children: [
      { to: '/inventario/core-eng', label: 'CORE-ENG', public: true },
      { to: '/inventario/nfvi', label: 'NFVI', public: true },
      { to: '/inventario/pceng', label: 'PCENG', public: true },
      { to: '/inventario/dbeng', label: 'DBENG', public: true },
      { to: '/inventario/voiceeng', label: 'VOICEENG', public: true },
    ],
   },
